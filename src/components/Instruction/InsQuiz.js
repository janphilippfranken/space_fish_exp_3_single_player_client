        ...
        <div className={Classes.InsQuiz}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <div className={Classes.QuizContainer}>
                    ...
                    <li className={Classes.Q5}>5. You can’t be sure <b>if the other players can see each other's judgments</b> or if they can see your judgments. You will need to <b>infer who sees whose judgments</b> by looking at how other players' judgments change over time.<br></br><br></br></li>
                    <li className={Classes.Q6}>6. You should consider current and past evidence (fish / players' judgments) when making a judgment. You will be paid £0.15 bonus for every judgment you make in the right direction (max. total bonus = £1.50).</li>
                     {/*<b>DEV::STRUCTURE UNKNOWN</b>You can’t be sure if the other players are seeing each other's judgments. However you can work this out by...  */}
