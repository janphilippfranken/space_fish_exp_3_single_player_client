        ...
        <div className={Classes.InsQuiz}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <div className={Classes.QuizContainer}>
                    ...
                    <li className={Classes.Q5}>5. You can directly see <b>whether the other players can see each other's judgments and if they can see your own judgments</b>. You <b>should consider</b> this knowledge when updating your own judgments.<br></br><br></br></li>
