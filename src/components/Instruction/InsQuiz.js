        ...
        <div className={Classes.InsQuiz}>
            ...
            <div className={Classes.InnerContainer}>
                ...
                <div className={Classes.QuizContainer}>
                    ...
                    <li className={Classes.Q5}>5. You can’t be sure if the other players are seeing each other's judgments or if they can see your judgments. You will need to <b>infer who sees whose judgments</b> by looking at how other players' judgments change over time.</li>
