...
const Register = () => {
    ...
    return (
        <>
        <h4>You have {remainingTime} seconds left to register.</h4>
        <p>Please enter your username. The length of your username has to be between 2-5 characters.</p><br></br>
        <input position={"absolute"} left={"50%"} type="text" placeholder="Name" value={participantName} onChange={e => setParticipantName(e.target.value)}/>
